...
specular_mask=imread('ZhuoerLyu-lyu.254/Assignment_1_tif_images/Apple/mask_dir_1.png');
specular_mask=double(rgb2gray(specular_mask));
lambertian_mask=imread('ZhuoerLyu-lyu.254/Assignment_1_tif_images/Apple/mask_I.png');
lambertian_mask=double(rgb2gray(lambertian_mask));
apple_mask=imread('ZhuoerLyu-lyu.254/Assignment_1_tif_images/Apple/applemask.png');
...
%% normal map and albedo map and rerender image
...
figure 
imshow(3*normal_matrix(:,:,3).*albedo)
